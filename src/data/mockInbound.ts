...
export const workers: WarehouseWorker[] = [
    ...
    activity: [
      {
        ...
        detail: 'MC-1001 received at Dock A',
      },
      {
        id: 'a-dock-2',
        kind: 'carton_received',
        at: new Date(Date.now() - 5 * 3600_000).toISOString(),
        detail: 'MC-1002 received at Dock A',
      },
    ],
  },
  {
    id: 'w-dock-out',
    name: 'Deepak Dock Out',
    email: 'dock-out@upbox.test',
    ...
    activity: [
      {
        ...
        detail: 'SKU NK-221 staged ×12',
      },
      {
        id: 'a-un-2',
        kind: 'product_damaged',
        at: new Date(Date.now() - 6 * 3600_000).toISOString(),
        detail: 'SKU AD-90 damaged ×1',
      },
    ],
  },
  {
    ...
    status: 'active',
    teamId: 'team-packing',
    lastLoginAt: new Date(Date.now() - 4 * 3600_000).toISOString(),
    activity: [],
  },
  {
    id: 'w-put-1',
    ...
    status: 'active',
    teamId: 'team-putaway',
    lastLoginAt: new Date(Date.now() - 28 * 3600_000).toISOString(),
    activity: [
      {
        id: 'a-put-1',
        kind: 'product_placed',
        at: new Date(Date.now() - 2 * 3600_000).toISOString(),
        detail: 'Placed NK-221 → A-01-02-B',
      },
      {
        id: 'a-put-2',
        kind: 'product_placed',
        at: new Date(Date.now() - 8 * 3600_000).toISOString(),
        detail: 'Placed PM-44 → B-02-01-A',
      },
      {
        id: 'a-put-3',
        kind: 'carton_completed',
        at: new Date(Date.now() - 9 * 3600_000).toISOString(),
        detail: 'Carton MC-0998 complete',
      },
    ],
  },
  {
  ...
  },
  {
    ...
    role: 'WMS_SUPERVISOR',
    kind: 'SUPERVISOR',
    streams: ['inbound', 'outbound'],
    openProductCount: 0,
    status: 'active',
    teamId: 'team-ops',
    lastLoginAt: new Date(Date.now() - 1 * 3600_000).toISOString(),
    activity: [
      {
        id: 'a-sup-1',
        kind: 'products_assigned',
        at: new Date(Date.now() - 2 * 3600_000).toISOString(),
        detail: 'Assigned 8 products to putaway queue',
      },
    ],
  },
]
