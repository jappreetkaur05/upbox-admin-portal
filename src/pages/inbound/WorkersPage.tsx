            ...
            <table className="min-w-[720px] w-full border-collapse text-left text-sm">
              <thead className="bg-slate-50 text-[11px] font-semibold uppercase tracking-wide text-slate-500">
                <tr>
                  ...
                  <th className="px-4 py-3">Kind / stream</th>
                  ...
                  return (
                    <tr key={w.id} className="hover:bg-indigo-50/40">
                      ...
                      <td className="px-4 py-3 text-xs text-slate-600">
                        <div className="font-semibold">{w.kind}</div>
                        <div className="uppercase tracking-wide text-slate-400">{w.streams?.join(' · ')}</div>
                      </td>
                      <td className="px-4 py-3">
                        <span
                          className={cn(
                        ...
                        {isSupervisor ? (
                          ...
                          <select
                            ...
                            onChange={(e) =>
                              void onAssign(
                                w,
                                e.target.value as Exclude<WarehouseWorker['role'], 'WMS_SUPERVISOR'>
                              )
                            }
                          >
