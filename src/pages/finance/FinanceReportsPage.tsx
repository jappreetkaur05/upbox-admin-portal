...
export function FinanceReportsPage() {
  const snap = financeAdminService.reportSnapshot()
  ...
  const kpis = [
    ...
    },
    {
      ...
      value: snap.customerBillingTotal,
    ...
    },
    {
      ...
      value: snap.vendorPaymentsTotal,
  ...
  return (
    <div>
      <PageHeader
        ...
        description="Revenue, billing, outstanding, warehouse/storage/pick-pack revenue, GST, and P&L summary."
      />
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        <section className="surface-panel p-4">
          <h2 className="font-heading text-base font-semibold">Warehouse revenue mix</h2>
        ...
        <section className="surface-panel p-4">
          <h2 className="font-heading text-base font-semibold">Profit & loss (mock)</h2>
          <dl className="mt-4 space-y-3 text-sm">
            <div className="flex justify-between">
