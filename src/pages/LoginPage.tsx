...
const DEMO_ACCOUNTS = [
  { email: 'supervisor@upbox.test', role: 'Supervisor (all)' },
  { email: 'dock@upbox.test', role: 'Dock · Inbound' },
  { email: 'dock-out@upbox.test', role: 'Dock · Outbound' },
  { email: 'unpack@upbox.test', role: 'Unpacker' },
  { email: 'pack@upbox.test', role: 'Packer' },
  { email: 'putaway@upbox.test', role: 'Putaway' },
  { email: 'pick@upbox.test', role: 'Picker' },
]
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-gradient-to-br from-slate-100 via-sky-50 to-slate-100 px-4">
      <div className="w-full max-w-md rounded-2xl border border-slate-200 bg-white p-8 shadow-lg">
        ...
        <p className="mt-1 text-sm text-slate-500">Warehouse inbound & outbound admin</p>
